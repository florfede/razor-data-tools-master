...
{
    public class ASCAP_EarningsModel : PageModel
    {
        [BindProperty]
        ...
        {
            //TODO:  Determine what type of file - Old or New - then adjust the array columns as necessary
                ...
                try
                {
                    ...
                    foreach (var file in files)
                    {
                        ...
                        using (var stream = new MemoryStream())
                        {
                            ...
                            stream.Position = 0;
                            importedRecordCount = Utils.Csv.ImportASCAPEarningsCsvAndInsertIntoDatabase(stream, importFileName);
